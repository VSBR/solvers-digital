...
namespace Sass {
  ...
  typedef const char* (*Sass_Simple_C_Function)(const char*, const char*);
  ...
  struct Context {
    ...
    vector<string> custom_function_names; // registered custom_function_names
    Sass_Simple_C_Function custom_function; // custom_function c_ptr
